                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    <a href="<?php echo site_url('toko/edit/' . $val->idToko); ?>" type="button" class="btn btn-secondary">Edit</a>
                                    <a href="<?php echo site_url('produk/index/' . $val->idToko); ?>" type="button" class="btn btn-secondary">Kelola Toko</a>
                                    <a href="<?php echo site_url('toko/delete/' . $val->idToko); ?>" type="button" class="btn btn-secondary">Hapus</a>
                                </div>
                            </td>
                        </tr>
                    <?php $no++;
