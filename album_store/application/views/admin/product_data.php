    ...
    <div class="table-responsive mt-3">
        <table class="table">
                ...
                <tr>
                    ...
                    <td><?php echo $prdk->tanggal_masuk ?></td>
                    <td><?php echo anchor('admin/product_data/edit/' .$prdk->kode, '<div class="btn btn-primary">Edit</div>')?></td>
                    <td><?php echo anchor('admin/product_data/delete/' .$prdk->kode, '<div class="btn btn-danger">Delete</div>')?></td>
                </tr>
